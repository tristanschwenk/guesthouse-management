        ...
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <nav class="ml-6 flex space-x-8">
              ...
              <NuxtLink to="/admin/calendar" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                Calendar
              </NuxtLink>
          ...
          <div class="flex items-center">
            <NuxtLink to="/" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-indigo-600 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              View Site
            </NuxtLink>
          </div>
        </div>
