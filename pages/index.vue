  ...
  <div>
    <div class="bg-white">
      <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div class="text-center">
          <h1 class="text-base font-semibold text-indigo-600 tracking-wide uppercase">Guesthouse Management</h1>
          <p class="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl">Book your perfect stay</p>
          <p class="max-w-xl mt-5 mx-auto text-xl text-gray-500">Discover our beautiful rooms and book your stay with us.</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-gray-50">
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <h2 class="text-2xl font-extrabold tracking-tight text-gray-900 mb-8">Our Rooms</h2>
