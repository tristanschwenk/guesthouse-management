<template>
  <div class="booking-form">
    <div v-if="step === 1" class="date-selection">
      ...
      <div v-if="selectedDates.length === 2" class="mt-6 bg-gray-50 p-4 rounded-md">
    ...
    <div v-if="step === 2" class="guest-information">
      ...
      <form @submit.prevent="goToStep(3)" class="space-y-4">
        ...
        <div>
          <label for="guestPhone" class="block text-sm font-medium text-gray-700">Phone Number</label>
          <input 
            type="tel" 
            id="guestPhone" 
    ...
    <div v-if="step === 3" class="booking-review">
      ...
      <div class="bg-gray-50 p-4 rounded-md mb-6">
        ...
        <div class="grid grid-cols-2 gap-2 text-sm">
          ...
          <div v-if="guestInfo.specialRequests" class="text-gray-500">Special Requests:</div>
          <div v-if="guestInfo.specialRequests">{{ guestInfo.specialRequests }}</div>
        </div>
      </div>
    ...
    <div v-if="step === 4" class="booking-confirmation">
      <div class="text-center">
        ...
        <h2 class="mt-3 text-lg font-medium text-gray-900">Booking Confirmed!</h2>
        <p class="mt-2 text-sm text-gray-500">
          Thank you for your booking. We've sent a confirmation email to {{ guestInfo.email }}.
        </p>
        <div class="mt-6">
          <button 
            type="button"
